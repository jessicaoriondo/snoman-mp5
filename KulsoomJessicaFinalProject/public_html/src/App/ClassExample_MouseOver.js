...
//
//        var pivotPos = this.mLeftChild.getRenderableAt(0).getXform().getPosition();
//        var pivotPosWC = vec2.fromValues(0, 0);
//
//        vec2.transformMat4(pivotPosWC, pivotPos, m);
//        this.mBlueSq.getXform().setPosition(pivotPosWC[0], pivotPosWC[1])
//        console.log("Left arm pivot pos: " + pivotPosWC);
...
//        
//        var rotateRedPos = this.mTopChild.getRenderableAt(0).getXform().getPosition();
...
//        
//        var yellowPos = this.mRightChild.getRenderableAt(0).getXform().getPosition();
...
//        
//        var purplePos = this.mTopRChild.getRenderableAt(0).getXform().getPosition();
...
//        
//        var orangePos = this.mButtons.getRenderableAt(0).getXform().getPosition();
...
//        
//        var greenPos = this.mMouth.getRenderableAt(0).getXform().getPosition();
